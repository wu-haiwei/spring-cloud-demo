...
public class UserController {
    ...
    private static final String PROVIDER_SERVICE = "http://SPRING-CLOUD-EUREKA-PROVIDER:8000/";
    ...
    public Response<UserInfo> queryUser(@PathVariable("userId") Integer userId) {
        String url = PROVIDER_SERVICE + "provider/api/user/detail/" + userId;
    ...
    public PageResponse<UserInfo> listUser() {
        String url = PROVIDER_SERVICE + "provider/api/user/list";
    ...
    public Response<Integer> save(@RequestBody UserInfo userInfo) {
        String url = PROVIDER_SERVICE + "provider/api/user/save";
    ...
    public Response<Integer> delete(@PathVariable("userId") Integer userId) {
        String url = PROVIDER_SERVICE + "provider/api/user/delete/" + userId;
